...
//Code available on: //
// https://github.com/NiceNicoN/Robotics-2/blob/main/Auto_Follow_Command.ino //
...
void loop() {
 float distance = Ultrasonic();
  ...
  else if (distance > 10 && distance < 30){      /////otherwise, if true that Mommy is more than 10 cm and less than 30 cm in FRONT of the Duck, run next line of code.
  ...
  else if (distance <= 8){      /////otherwise, otherwise, if true that Mommy is less than or = 8 cm in FRONT of the Duck, run next line of code.
